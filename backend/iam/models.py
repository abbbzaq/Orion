...
class SysUser(models.Model):
	user = models.OneToOneField(User, verbose_name="系统用户", on_delete=models.CASCADE, related_name="sys_profile")
...
class SysMenu(models.Model):
	...
	parent = models.ForeignKey("self", verbose_name="父级菜单", on_delete=models.CASCADE, null=True, blank=True, related_name="children")
